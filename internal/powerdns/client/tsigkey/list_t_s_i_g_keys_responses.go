...
*/
type ListTSIGKeysOK struct {
	Payload []*models.TSIGKey
}

func (o *ListTSIGKeysOK) Error() string {
	return fmt.Sprintf("[GET /servers/{server_id}/tsigkeys][%d] listTSIGKeysOK  %+v", 200, o.Payload)
}
func (o *ListTSIGKeysOK) GetPayload() []*models.TSIGKey {
	return o.Payload
}

func (o *ListTSIGKeysOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
